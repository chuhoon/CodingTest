...
// o라는 객체의 생성자를 알아낸다. 그 객체의 생성자의 포로토타입 객체를 확인했는데 저장되어 있는 객체인 new Super()가 만들어 놓은 객체를 확인하고
// Super가 만들어 놓은 객체 t.ultraProp의 값인 4를 반환한다. 이 값이 없을 경우 생성자 Ultra()로 넘어가고 true의 값을 반환하게된다.
